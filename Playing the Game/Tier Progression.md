...
A typical **Cogent Roleplay** campaign is broken into four parts (Campaign, Story Arcs, Chapters, and Scenes) *(see **[Story Structure](<../Running the Game/Story Structure.md>)**)*.  Character can expect (but are not entitled to) the following reward per campaign part:
